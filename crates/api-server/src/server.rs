...
impl ApiServer {
    ...
    pub async fn start_http(&self) -> anyhow::Result<()> {
        ...
        let loyalty_routes = Router::new()
            ...
            .route("/v1/loyalty/balance/{user_id}", get(loyalty_rest::handle_balance))
            .route("/v1/loyalty/reward-signal", post(loyalty_rest::handle_reward_signal))
        ...
        let channel_routes = Router::new()
            ...
            .route("/v1/webhooks/sendgrid", post(channel_rest::handle_sendgrid_webhook))
            .route("/v1/channels/email/analytics/{activation_id}", get(channel_rest::handle_email_analytics))
